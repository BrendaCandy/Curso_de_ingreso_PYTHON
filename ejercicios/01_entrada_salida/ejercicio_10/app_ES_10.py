...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        importe_descuento= "{0:.2f}".format(importe_descuento)
        importe_descuento_float= float(importe_descuento)
       
        importe_final= importe-importe_descuento_float
        importe_final_str= str(importe_final)

        alert("UTN FRA", "Su importe final es "+importe_final_str)
