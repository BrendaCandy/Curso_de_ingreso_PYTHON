...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        alert("Resultado", "El resultado de la suma es "+ sumas_str )
    ...
    def btn_restar_on_click(self):
        ...
        alert("Resultado", "El resultado de la resta es "+ resta_str)
    ...
    def btn_multiplicar_on_click(self):
        ...
        operador_a_int= int(operador_a)
        operador_b_int= int(operador_b)
        mult= operador_a_int*operador_b_int
        mult_str= str(mult)

        alert("Resultado", "El resultado de la multiplicacion es "+ mult_str )
    ...
    def btn_dividir_on_click(self):
        ...
        division= "{0:.2f}".format(division)
        division_str= str(division)

        alert("Resultado", "El resultado de la division es "+ division_str )
